...
comment on table staging.review is 'Transient Review data scraped from website and derived data (ex. derived_title_sform)';
comment on column staging.review.book_uid is 'Unique identifier of the book as used by website';
comment on column staging.review.derived_book_id is 'Derive/store md5 hashing of book title to ease the integration bit';
...
comment on column integration.reviewer.id is 'Primary-key generated by MD5 hashing of string <site_id|pseudo>';
